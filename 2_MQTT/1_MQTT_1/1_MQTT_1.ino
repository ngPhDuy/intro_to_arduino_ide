...
UltraSonicDistanceSensor ultrasonic(D9, D10); //cảm biến nối với D3-D4
SoftServo myservo;
...
void TaskSmartDoor(void* params);
...
void setup() {
  ...
  xTaskCreate( TaskSmartDoor, "Task Smart Door" ,2048  ,NULL  ,2 , NULL);
...
void TaskSmartDoor(void* params) {
  while(1) {
    Serial.println("Task Smart Door");
